...
local session              = ipc .. "panel-toggle launcher '/session '"
...
local closeWindowBind = hl.bind(mainMod .. " + SHIFT + W", hl.dsp.window.close())
-- closeWindowBind:set_enabled(false)
hl.bind(mainMod .. " + SHIFT + M", hl.dsp.exec_cmd("uwsm stop"))
-- hl.bind(mainMod .. " + M", hl.dsp.exec_cmd("command -v hyprshutdown >/dev/null 2>&1 && hyprshutdown || hyprctl dispatch 'hl.dsp.exit()'"))
hl.bind(mainMod .. " + V", hl.dsp.window.float({ action = "toggle" }))
hl.bind(mainMod .. " + P", hl.dsp.window.pseudo())
hl.bind(mainMod .. " + F", hl.dsp.window.fullscreen({ mode = "maximized" })) -- mode: "fullscreen" or "maximized"
...
hl.bind("XF86MonBrightnessUp",           hl.dsp.exec_cmd("asdbctl up -s 5"),                                { locked = true, repeating = true })
hl.bind("SHIFT + XF86MonBrightnessUp",   hl.dsp.exec_cmd("asdbctl up -s 1"),                                { locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown",         hl.dsp.exec_cmd("asdbctl down -s 5"),                              { locked = true, repeating = true })
hl.bind("SHIFT + XF86MonBrightnessDown", hl.dsp.exec_cmd("asdbctl down -s 1"),                              { locked = true, repeating = true })
